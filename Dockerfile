...
# Compilation
RUN pacman -Syu --noconfirm clang afl llvm sdl2 xorg-server xf86-video-dummy xorg-apps make cmake autoconf tree gcovr lcov gcc tree doxygen ruby python asciidoctor
